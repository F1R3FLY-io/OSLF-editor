...
export class SearchInput extends HTMLElement {
    ...
    private headerSearchIcon: HTMLElement | null = null;
        ...
        if (this.shadowRoot) {
            ...
            this.shadowRoot.innerHTML = `
				...
				<div class="header-container">
					...
					<button type="button" class="icon-button" data-icon="header-search">
				...
				<div class="search-container">
					...
					<button type="button" class="icon-button close-button" data-icon="close">
    ...
    setupEventListeners() {
        ...
        this.headerSearchIcon = this.shadowRoot.querySelector('[data-icon="header-search"]');
        this.closeButton = this.shadowRoot.querySelector('[data-icon="close"]');
